...
import { handleLinkClick } from "./LeftSidebar";
...
const SmallSidebar = () => {
  ...
  return (
    ...
    >
      ...
      >
        <Link to="/" className="text-[24.85px]" onClick={toggle}>
        ...
        <div className="flex flex-col justify-between h-[calc(100vh-80px)] overflow-y-auto">
            ...
            {links.map((link) => {
              ...
              return (
                <NavLink
                  ...
                  className={({ isActive }) =>
                    isActive
                      ? "small-nav-link bg-primary text-white font-bold"
                      : "small-nav-link"
                  }
                  onClick={toggle}
                >
          ...
          {user ? (
            <button type="button" className="small-nav-link" onClick={logout}>
              <BiLogOut />
